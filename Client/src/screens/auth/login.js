...
export default function Login() {
    ...
    async function authLogin(e) {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost/api/auth/authLogin',{
                method:"POST",
                headers:{
            ...
            if(data.msg === "Login Success")
                gotoHome(data.name,data.email,data.number)
    ...
    const gotoHome =  (name,email,number)=>{
